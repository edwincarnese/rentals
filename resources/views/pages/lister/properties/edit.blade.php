                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12 mb-30">
                                            ...
                                            <select class="nice-select" name="bedroom">
                                                <option value="0" @if($property->bedroom == 0) selected @endif>0</option>
                                        ...
                                        <div class="col-md-4 col-12 mb-30">
                                            ...
                                            <select class="nice-select" name="bathroom">
                                                <option value="0" @if($property->bathroom == 0) selected @endif>0</option>
                                        ...
                                        <div class="col-md-4 col-12 mb-30">
                                            ...
                                            <select class="nice-select" name="kitchen">
                                                <option value="0" @if($property->kitchen == 0) selected @endif>0</option>
